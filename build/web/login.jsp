...
<div class="container py-4" style="margin-top:-35px; min-height:76vh;">
                ...
                <div class="card-body">
                    ...
                    <form action="login" method="post" novalidate>
                        ...
                        <div class="text-center mt-3">
                            ...
                            <a href="register.jsp" class="ms-1 fw-semibold" style="text-decoration:none;">
                                Đăng ký
                            </a>
                        </div>
...
form.addEventListener("submit", function(e){
    ...
    inputs.forEach(i => {
        validateField(i);
        if(i.classList.contains("is-invalid")) ok = false;
    });
